...
public class SecurityConfig {
     ...
     * Uso  para darle prioridad sobre cualquier otra cadena
     * que pudiera existir en el contexto. El  restringe
     * esta cadena solo a las rutas  y ,
     * dejando otras rutas (si las hubiera) sin protección por ahora — pero como
     *  cierra todo lo que no coincida, no hay
     * fugas.
     * 
     * 

     * Deshabilito CSRF porque WebSocket no es vulnerable a
     ...
     * Política de sesión STATELESS porque este servicio no
     * mantiene estado de sesión HTTP. Todas las decisiones de autenticación se
     * delegan al Gateway.
     * 
     * 

     * Actuator health se permite sin autenticación para que
