 ...
 * </p>
 * <p>
 * Decidí que la interfaz solo tenga un método {@code generate}. La
 * validación/decodificación de tokens entrantes la maneja Spring Security
 * directamente mediante el {@code JwtDecoder} configurado en la capa de
...
public interface JwtService {
     ...
     * @param email  email del usuario (se usa como el {@code subject} del token)
