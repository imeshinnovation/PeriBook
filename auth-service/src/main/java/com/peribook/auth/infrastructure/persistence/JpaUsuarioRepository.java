...
/**
 * Adaptador de persistencia que implementa el puerto UsuarioRepository
 ...
 * Extiendo tanto UsuarioRepository (mi interfaz de dominio) como
 * JpaRepository (la interfaz de Spring Data) para heredar los métodos
 * CRUD estándar. La magia está en que Spring Data genera automáticamente la
 * implementación de , y yo solo implemento los
 * métodos del repositorio de dominio usando  methods para
 * sobreescribir y traducir entre dominio y entidad JPA.
 * 
 * 

 * Uso  en lugar de  para forzar la escritura
...
public interface JpaUsuarioRepository extends UsuarioRepository, JpaRepository<UsuarioEntity, UUID> {
    ...
    /**
     * Implementa la búsqueda del dominio (UsuarioRepository#findByEmail).
     * Traduce el Value Object Email a String para la consulta JPA,
    ...
    /**
     * Implementa el guardado del dominio (UsuarioRepository#save).
     * Convierte el agregado de dominio a entidad JPA, persiste con
     *  y devuelve el agregado reconstituido.
     *
