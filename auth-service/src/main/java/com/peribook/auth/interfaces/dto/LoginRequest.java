 ...
 * Es un  simple con anotaciones de Jakarta Bean Validation
 ...
 * se replica también en com.peribook.auth.domain.Password#fromRaw
...
public record LoginRequest(
         ...
         * de email válido (validación Jakarta ).
         */
