 ...
 * Opté por un constructor privado y dos fábricas estáticas (#dar y
 * #reconstituir) para separar claramente la creación desde intención (nuevo
...
public class Like {
    ...
    /**
     * Crea un nuevo  desde cero — genera un ID aleatorio y timestamps
    ...
    /**
     * Reconstituye un  desde el repositorio con todos los valores ya
