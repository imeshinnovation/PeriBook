...
/**
 * Configuración JWT externalizada, mapeada directamente desde 
 * en el application.yml.
 * 

 * Usé un  de Java 21 por varias razones: es inmutable por
 ...
 * archivos locales generados por , y en producción
 ...
 * @param expiration    Duración de validez del token. La puse como Duration
